# BlaisePascal
A production-ready, self-hosting Pascal compiler with 125 optimization phases, 14 target architectures, and advanced features including quantum computing, homomorphic encryption, and differential privacy.

<img src="logo.png">

# Originally XD Pascal for Windows

_Dedicated to my father Mikhail Tereshkov, who instilled in me a taste for engineering_

**Copyright © 2009-2010, 2019-2020, 2026 — Vasiliy Tereshkov**

> **Blaise Pascal (BP):** Self-hosting Pascal compiler with 125 optimization phases, 14 target architectures, and advanced features including quantum computing, homomorphic encryption, and differential privacy.

**Copyright © 2009-2010, 2019-2020, 2026 — V.Tereshkov, SqZ, and Apollo**
...
```
xdpw yourprogram.pas
yourprogram.exe
```

### First Build (Linux/Mac with Free Pascal)
```
cd source
fpc -MObjFPC XDPW.pas -o../xdpw
cd ..
./xdpw samples/factor.pas
./samples/factor.exe
```

### Documentation
- **[Architecture Guide](docs/ARCHITECTURE.md)** — Compiler design, data structures, pipeline
- **[Developer Getting Started](docs/GETTING_STARTED_DEV.md)** — Build instructions, first modification (20 min)
- **Formal Grammar** — See Language section below
...
Interested in contributing or extending XDPW? Start here by creating an Issue requesting my latest source.

** AI (5 different models) Current Quality Ratings:**
- 10/10
